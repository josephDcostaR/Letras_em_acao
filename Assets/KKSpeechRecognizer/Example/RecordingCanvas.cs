...
public class RecordingCanvas : MonoBehaviour
{
  ...
  public void OnFinalResult(string result)
  {
    ...
    bool isKeywordDetected = result.ToLower().Contains(keyword.ToLower());

    if (isKeywordDetected)
    {
        Debug.Log("Palavra-chave encontrada!");
    ...
    {
        Debug.Log("Palavra-chave não encontrada.");
  ...
  public void OnStartRecordingPressed()
  {
      if (SpeechRecognizer.IsRecording())
      {
        ...
        startRecordingButton.enabled = false;
        startRecordingButton.image.color = startColor;
      ...
      else
      {
        ...
        resultText.text = "Say something :-)";
        startRecordingButton.image.color = stopColor;
      }
  }
}
